...
class Design_63_63_AIRaider extends ActorScript
{
	...
	override public function init()
	{
		...
		/* ========================= Type & Type ========================== */
		addSceneCollisionListener(getActorType(8).ID, getActorType(50).ID, function(event:Collision, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled)
			{
